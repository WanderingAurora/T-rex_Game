...
function setup() {
  ...
  invisibleGround = createSprite(200,190,400000,10);
...
function draw() {
  ...
  console.log(trex.x);
//infi.
  if(Math.round(trex.x)%40==0)
  ground.x=trex.x+200-trex.velocityX;
